...
export default function CarrosselWeb({ noticias }: CarrosselWebProps) {
    ...
    return (
        <div className="w-full h-[340px] relative hidden max-w-[1300px] mx-auto md:block overflow-hidden lg:h-[450px] xl:h-[550px]">
                    ...
                    >
                        {
                            grupo.map((noticia, noticiaIndex) => {
                                return (
                                    ...
                                    >
                                        <Link href={`/noticia/${createSlug(noticia.id)}`} className='w-full h-full bg-red-400 relative'>
